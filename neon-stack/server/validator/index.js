...
const APP_ID = process.env.APP_ID || 'com.yourstudio.neonstack';
...
function handleHealth(res) {
  send(res, 200, { ok: true, service: 'neon-stack-validator', products: PRODUCTS.length });
}
